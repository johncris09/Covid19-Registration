													...
													<form  id="update-user-form" method="post">
														<div class="card-block">
															...
															<div class="form-group row">
																...
																<div class="col-sm-10">
																	<input type="text" value="<?php echo $user['name'] ?>" name="name" class="form-control" placeholder="Name" required autofocus>
																</div>
															</div>
															<div class="form-group row">
																<label class="col-sm-2 col-form-label">Username <span class="text-danger">*</span></label>
																<div class="col-sm-10">
																	<input type="text"  value="<?php echo $user['username'] ?>" name="username" class="form-control" placeholder="Username"  required>
																</div>
															</div>  
															<div class="form-group row">
																	...
																	<select name="role_type" class="form-control">
																		...
																		<?php
																			foreach($this->config->item('role_type') as $key => $val){
																				if($user['role_type'] == $key){
																					$selected = "selected";
																				}else{
																					$selected = "";
																				}
																				echo '
																					<option '.$selected.' class="text-capitalize" value="'.$key.'">'.$val.'</option>
																				';
